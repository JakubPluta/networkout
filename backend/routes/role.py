...
@router.get('/name/{role_name}', response_model=schemas.RoleDB, status_code=status.HTTP_200_OK)
...
@router.put('/{user_id}/add-role/{role_id}', response_model=schemas.UserFromDB)
